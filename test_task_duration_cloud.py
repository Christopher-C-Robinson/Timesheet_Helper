...
def test_detects_windows_onedrive_path():
    path = Path(r"C:\Users\me\OneDrive - OmniByte Technology, Inc\Weekly Updates")
...
def test_detects_windows_onedrive_env_root():
    path = Path(r"C:\Users\me\CompanyDrive\Weekly Updates\week.docx")
...
def test_detects_macos_onedrive_cloudstorage_path():
    path = Path("/Users/me/Library/CloudStorage/OneDrive-OmniByte/Weekly Updates/week.docx")
...
def test_open_saved_word_document_is_authoritative():
    path = Path(r"C:\Users\me\OneDrive - Org\Weekly Updates\week.docx")
...
def test_cloud_fail_rejects_cloud_backed_files_before_reading():
    root = Path(r"C:\Users\me\OneDrive - Org\Weekly Updates")
...
def test_sharepoint_url_maps_to_local_onedrive_path():
    path = Path(
        r"C:\Users\me\OneDrive - OmniByte Technology, Inc\Weekly Updates\2026"
        r"\Week 25 2026 Weekly Update.docx"
    )
    full_name = (
        "https://omnibytetech-my.sharepoint.com/personal/me/Documents/"
